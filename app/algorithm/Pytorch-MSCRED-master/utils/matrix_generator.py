...
def generate_signature_matrix_node(
	raw_data_path, save_data_path, win_size=[10, 30, 60], min_time=0, max_time=20000, 
	gap_time=10):
...
def generate_train_test_data(
	save_data_path, win_size=[10, 30, 60], gap_time=10, step_max=5, 
	train_start=0, train_end=8000, test_start=8000, test_end=20000):
...
if __name__ == '__main__':
	...
	raw_data_path = './data/MSCRED_test.csv'
	...
	if ts_type == "node":
		generate_signature_matrix_node(
			raw_data_path=raw_data_path, save_data_path=save_data_path, 
			win_size=win_size, min_time=min_time, max_time=max_time, gap_time=gap_time
		)

	generate_train_test_data(
		save_data_path=save_data_path, win_size=win_size, gap_time=gap_time, step_max=step_max, 
