class Constant(object):
    ...
    TABLE_H2_LEAKAGE_DATA_EXPIRE_TIME = 7200
    TABLE_H2_LEAKAGE_CAL_EXPIRE_TIME = 7200 # 172800
    TABLE_MAIN_EXPIRE_TIME = 14400
    MAX_CAPACITY_TABLE_H2_LEAKAGE_DATA = 360 # expire_time / 20
    MAX_CAPACITY_TABLE_H2_LEAKAGE_CAL = 360 # 8640
    ...
    H2_LEAKAGE_CAL_FILTER_TIME = 20
    H2_LEAKAGE_SLIP_TIME = 60
    H2_LEAKAGE_MODIFICATION_FACTOR = 0.5
    H2_FILL_JUDGE_NUMS = 30
    H2_FILL_JUDGE_RATIO = 0.8
